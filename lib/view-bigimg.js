(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ViewBigimg = factory());
    ...
    ImageViewer.prototype = {
      ...
      _init: function _init() {
        ...
        viewer._imageSlider = new TouchEvent(imageWrap, {
          ...
          // pinch
          onPinch: function onPinch(estart) {
      ...
      _clearFrames: function _clearFrames() {
      ...
      _calculateDimensions: function _calculateDimensions() {
